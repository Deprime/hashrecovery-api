...
return [
    ...
    */
    ...
    'custom' => [
      ...
      'bank_id' => [
        'required_if' => 'Необходимо указать банк, представителем которого является пользователь.'
      ],
      'password' => [
        'required_if' => 'Вы не заполнили поле Пароль.'
      ],
      'primary_file_id' => [
      ...
      'agreement_id' => [
        'required' => 'Необходимо прикрепить соглашение.',
      ],
      'poster_id' => [
        'required' => 'Необходимо прикрепить постер.',
      ],
      'cover_id' => [
        'required' => 'Необходимо прикрепить обложку.',
      ],
      'code' => [
        'exists' => 'Не верный код подтверждения.',
      ],
    ],
    ...
    */
    ...
    'attributes' => [
      ...
      'account_id'            => 'Счет',
      'patronymic'            => 'Отчество',
      'creator.patronymic'    => 'Отчество',
      'file_id'               => 'Файл-приложение',
      'fio'                   => 'ФИО',
      'link'                  => 'Ссылка',
      'price'                 => 'Цена',
      'amount'                => 'Сумма заемных средств',
      'bank_id'               => 'Банк',
      ...
      'ogrn'                  => 'ОГРН',
      'okpo'                  => 'ОКПО',
      'capital_ratio'         => 'Доля в УК',
      'nominal_price'         => 'Номинальная стоимость',
      'series'                => 'Серия',
      'number'                => 'Номер',
      ...
      'registred_at'          => 'Дата выдачи',
      'duration_at'           => 'Срок действия',
      'registrator_name'      => 'Кем выдана',
      'activity_types'        => 'Перечень видов лицензируемой деятельности',
      'post_index'            => 'Индекс',
      'primary_phone'         => 'Рабочий телефон',
      'capital'               => 'Уставной капитал',
      'registrator_name'      => 'Наименование регистрирующего органа',
      'registrator_address'   => 'Адрес регистрирующего органа',
      'name'                  => 'Имя',
      'username'              => 'Никнейм',
      'area'                  => 'Регион',
      'building'              => 'Дом',
      ...
      'email'                 => 'E-Mail адрес',
      'first_name'            => 'Имя',
      'creator.first_name'    => 'Имя',
      'last_name'             => 'Фамилия',
      'creator.last_name'     => 'Фамилия',
      'password'              => 'Пароль',
      ...
      'size'                  => 'Размер',
      'post'                  => 'Должность',
      'creator.post'          => 'Должность',
      'unit'                  => 'Подразделение',
      'creator.unit'          => 'Подразделение',
      'title_en'              => 'Наименование на английском языке',
      'title_short'           => 'Краткое наименование',
      'head'                  => 'ФИО руководителя',
      'head_post'             => 'Должность руководителя',
      'yandex_secret_key'     => 'SECRET KEY',
      'yandex_shop_id'        => 'SHOP ID',
      'category_id'           => 'Категория',
      'booking_type_id'       => 'Тип бронирования',
      'poster'                => 'Постер',
      'cover'                 => 'Обложка',
      'poster_id'             => 'Постер',
      'cover_id'              => 'Обложка',
      'image'                 => 'Изображение для галереи',
      'start_at_date'         => 'Дата начала мероприятия',
      'finish_at_date'        => 'Дата завершения мероприятия',
      'start_at_time'         => 'Время начала мероприятия',
      'finish_at_time'        => 'Время завершения мероприятия',
      'limit_type'            => 'Тип ограничения',
      'limit_days'            => 'Количество дней',
      'limit_date'            => 'Установленная дата',
      'limit_people'          => 'Количество мест',
      'territory_id'          => 'Муниципалитет',
      'worktime'              => 'Режим работы',
      'hotel_type_id'         => 'Класс объекта размещения',
      'cafe_type_id'          => 'Класс объекта общественного питания',
      'stars '                => 'Звездность',
      'doc_series_number'     => 'Серия и номер паспорта',
      'doc_date'              => 'Дата выдачи паспорта',
      'doc_executor'          => 'Кем выдан паспорт',
      'agreement'             => 'Соглашение',
      'binding_type'          => 'Тип привязки',
      'have_hire'             => 'Прокат или аренда имущества',
      'geolocation'           => 'Координаты',
      'grid'                  => 'Режим оказания услуг',
      'duration_id'           => 'Продолжительность',
      'date_start'            => 'Дата начала',
      'date_end'              => 'Дата окончания',
      'type_id'               => 'Тип',
      'class_id'              => 'Категория',
      'head_id'               => 'Представитель агентства',
    ],
];
